Добро пожаловать! Меняя зовут Владимир.
=================================================================================================================================

Front-end разработчик (React)
-----------------------------

Я изучаю Front-end разработку, а именно создание сайтов на React. Делал сайты на чистом Html, Css, JavaScript для баз отдыха. Стараюсь развиваться в этой сфере и есть большое желание работать в компании, где смогу применять свои знания, развиваться и создавать классные веб-сайты.
...
* 💬  Ask me about Нравится изучать алгоритмы.
